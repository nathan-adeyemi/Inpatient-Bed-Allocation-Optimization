...
if [ "$(uname)" == "Darwin" ]; then
    ...
    Rscript src/Simulations/r-setup.R
else
    ...
    singularity exec --bind "/scratch/:/scratch/,/work/:/work/" /shared/container_repository/rstudio/rocker-geospatial-4.2.1.sif Rscript src/Simulations/r-setup.R
fi
