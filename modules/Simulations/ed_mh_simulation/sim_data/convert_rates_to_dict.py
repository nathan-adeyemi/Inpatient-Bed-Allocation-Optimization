...
rates=pd.read_excel('modules/Simulations/ed_mh_simulation/sim_data/Rates5.xlsx').drop_duplicates(subset='Bed_Group',keep='first')
...
with open(file = 'modules/Simulations/ed_mh_simulation/sim_data/rates5.pkl', mode = 'wb') as f:
